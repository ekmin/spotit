      ...
      <ul className="no-scrollbar pb-8 px-[49vw] w-full flex gap-8 snap-x overflow-x-auto self-center">
        {items.map((_, index) => (
          <li key={index} className="snap-center">
            <div className="relative flex-shrink-0 max-w-[95vw] overflow-hidden rounded-3xl border-2 border-secondary-dark-color shadow">
              <div className="animate-pulse relative h-100 w-[768px] p-12 flex flex-col justify-between items-start">
                <div className="h-6 w-full mb-4 bg-slate-200"></div>
                <div className="h-6 w-full mb-4 bg-slate-200"></div>
